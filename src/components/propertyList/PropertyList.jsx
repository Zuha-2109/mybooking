  ...
  return (
    <div className='pList'>
        <div className='pListItem'>
            ...
            <div className="pListTitles">
                <h1>Villas</h1>
                <h2>2245 properties</h2>
                </div>
                </div>
                <div className='pListItem'>
            <img src="https://q-xx.bstatic.com/xdata/images/hotel/263x210/52979454.jpeg?k=6ac6d0afd28e4ce00a8f817cc3045039e064469a3f9a88059706c0b45adf2e7d&o=" 
            alt="" 
            className="pListImg" />
            <div className="pListTitles">
                <h1>Cabin</h1>
                <h2>1255 properties</h2>
                </div>
                </div>
                <div className='pListItem'>
            <img src="https://r-xx.bstatic.com/xdata/images/xphoto/263x210/45450074.jpeg?k=7039b03a94f3b99262c4b3054b0edcbbb91e9dade85b6efc880d45288a06c126&o=" 
            alt="" 
            className="pListImg" />
            <div className="pListTitles">
                <h1>Cottages</h1>
                ...
                <div className='pListItem'>
            <img src="https://r-xx.bstatic.com/xdata/images/xphoto/263x210/45450113.jpeg?k=76b3780a0e4aacb9d02ac3569b05b3c5e85e0fd875287e9ac334e3b569f320c7&o=" 
            alt="" 
            className="pListImg" />
            <div className="pListTitles">
